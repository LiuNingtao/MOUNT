...
data = dict(
    ...
    train=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root + f'DataSet/coco_valid_0318_no_occu/{str(fold)}/train_fake_tip.json',
    ...
    val=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root + f'DataSet/coco_valid_0318_no_occu/{str(fold)}/test_fake_tip.json',
        img_prefix=data_root + 'Data',
    ...
    test=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root + f'DataSet/coco_valid_0318_no_occu/{str(fold)}/test_fake_tip_p020_08.json',
        img_prefix=data_root + 'Data',
        pipeline=test_pipeline,
        ref_img_sampler=dict(
            num_ref_imgs=6,
...
# load_from = r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/work_dirs/mask_selsa_faster_rcnn_r50_dc5_1x_c04_needle1020_ignore_occu_fake_tip/epoch_20_010958.pth'
