...
data = dict(
    ...
    val=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root + f'DataSet/coco_valid_0318_no_occu/{str(fold)}/val.json',
        img_prefix=data_root + 'Data',
    ...
    test=dict(
        classes=classes,
        type=dataset_type,
        ann_file=data_root + f'DataSet/coco_valid_0318_no_occu/{str(fold)}/test_p020_07.json',
        img_prefix=data_root + 'Data',
        pipeline=test_pipeline,
        ref_img_sampler=dict(
            num_ref_imgs=6,
...
# load_from = r'/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/work_dirs/mask_selsa_faster_rcnn_r50_dc5_1x_c04_needle1020/epoch_1.pth'
