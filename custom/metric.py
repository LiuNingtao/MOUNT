...
reso_path = r'/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/resolution.csv'
...
def load_pkl():
    path = r'/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/work_dirs/qdtrack_faster-rcnn_r50_fpn_4e_drchong_modified/result/pkl/fold0.pkl'
    array = np.load(path, allow_pickle=True)
    print(array)

def get_metric_tracking(hit_num_ths = 1, score_ths = 0.8, iou_ths = 0.5, dis_ths=1):
    anno_dir = r'/srv/fenster/people/Ningtao/Dataset/US3D/DrChongModified/coco_dataset'
    result_dir = r'/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/work_dirs/qdtrack_faster-rcnn_r50_fpn_4e_drchong_modified_train_test/result'
    save_dir = r'/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/document/metric/drchong_train_test'
...
def get_AUC():
    ...
    #     color="darkorange",
    #     lw=lw,
    #     label="ROC curve (area = {})".format(str(round(roc_auc, 2))),
    # )
    # plt.plot([0, 1], [0, 1], color="navy", lw=lw, linestyle="--")
    # plt.xlim([0.0, 1.0])
    # plt.ylim([0.0, 1.05])
    # plt.xlabel("Sensitivity")
    # plt.ylabel("1-Speccificiity")
...
def confusion_metrix_dataset():
    fold_num = 5
    result_dir = '/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/work_dirs/selsa_faster_rcnn_r50_dc5_1x_c04_fold{}/result'
    anno_dir = '/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/dataset/cross_valid/{}'
    imgae_sampled_json = json.load(open(r'/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/custom/doc/frame_sampled_thyroid.json'))
    save_path = '/srv/fenster/people/Ningtao/Project/ThyroidNodule/tracking/mmtracking/custom/metric_doc/thyroid_nodule'
    metric_dict = {'ID': [], 
                   'GT': [],
                   'NAME': [], 
                   'SCORE': [], 
...
def auc_video_split():
    fold_num = 5
    result_dir = '/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/work_dirs/selsa_troialign_faster_rcnn_r50_dc5_1x_c04_fold{}/result'
    anno_dir = '/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/dataset/cross_valid/{}'
    imgae_split_json = json.load(open(r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/doc/frame_splits_thyroid.json'))
    save_path = '/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/metric_doc/thyroid_nodule_mm'
    metric_dict = {'ID': [], 
                   'GT': [],
                   'NAME': [], 
                   'SCORE': []}
...
def get_KL_distance():
    ...
    for fold in range(1, 6):
        fold = str(fold)
        anno_path = f'/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/dataset/cross_valid/{fold}/test.json'
        result_path = f'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/work_dirs/selsa_troialign_faster_rcnn_r50_dc5_1x_c04_fold{str(fold)}/result/pretrain_mm_best.pkl'
        save_path = r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/metric_doc/kl_dis_pretrain_mm/'
...
def statistic_contrast():
    anno_dir = '/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/dataset/cross_valid/{}/'
    result_dir = '/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/work_dirs/selsa_troialign_faster_rcnn_r50_dc5_1x_c04_fold{}/result/pretrain_mm_best.pkl'
    data_dir = r'/srv/fenster/people/Ningtao/Dataset/US3D/C05Modified/data'
    ...
    # plt.show()
    data_frame.to_excel(r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/doc/bright_contrast_bbox_MM_new.xlsx', index=False)
    ...
    # sns.scatterplot(data=data_frame, x='BRIGHTNESS_N', y='CONTRAST_2', hue='TP')
    # plt.show()
    data_frame.to_excel(r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/doc/bright_contrast_instance_MM_new.xlsx', index=False)

def nodule_TPR_with_thres():
    """
    calculate the TPR of nodules with only the nodule bigger than the size threshold be counted.
    """
    result_path = r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/doc/bright_contrast_instance_mm.xlsx'
    save_path = r'/srv/fenster/people/Ningtao/Project/USVideo/tracking/mmtracking/custom/doc/TPR_size_thres.csv'
